---
title: "Check equilibrium solutions"
output: pdf_document
---
...
plot_nice1(x=EIR, as.list(as.data.frame(res_median)), col=list(2,3), pch=20, 
           ylab="evaluation time", main="evaluation time against EIR", legend_col=TRUE,
           legend_col_title="Function", legend_col_label=functionNames)

# plot evalutation time against treatment rate
plot_nice1(x=ft, as.list(as.data.frame(res_median)), col=list(2,3), pch=20, 
           ylab="evaluation time", main="evaluation time against treatment rate", 
           legend_col=TRUE, legend_col_title="Function", legend_col_label=functionNames)
```
