...
Start by installing and loading the package. Run the following lines, uncommenting the first line replacing `my_token` with your personal Github personal access token (this is required as the package is currently private).
