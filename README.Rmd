...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/mrc-ide/malariaModelFit?branch=master&svg=true)](https://ci.appveyor.com/project/mrc-ide/malariaModelFit)
